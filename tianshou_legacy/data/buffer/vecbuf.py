...
from tianshou_legacy.data import ReplayBuffer, ReplayBufferManager
from tianshou_legacy.data import PrioritizedReplayBuffer, PrioritizedReplayBufferManager
